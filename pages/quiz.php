        ...
        function pagination($total_pages, $num_adjacents_page) {
            echo '<div id="pagination">';
                if ($_SESSION["page_number"] > 1) {
                    echo '<a href="index.php?page=quiz&page_number=' . ($_SESSION["page_number"] - 1) . '"><img src="../images/category/left_arrow.png" alt="left-arrow"></a>';
                }
                ...
                for ($i = $min_display; $i <= $max_display; $i++) {
                    if ($i == $_SESSION["page_number"]) {
                        echo '<a id="main_page" class="pagination-number" href="index.php?page=quiz&page_number=' . $i . '">' . $i . '</a> ';
                    } else {
                        echo '<a class="pagination-number" href="index.php?page=quiz&page_number=' . $i . '">' . $i . '</a> ';
                    }
                }
                if ($_SESSION["page_number"] < $total_pages) {
                    echo '<a href="index.php?page=quiz&page_number=' . ($_SESSION["page_number"] + 1) . '"><img src="../images/category/right_arrow.png" alt="right-arrow"></a>';
                }
            echo '</div>';
        }
    ?>
